...
public final class InitClient {
	...
	public static void init() {
		...
		RegistryClient.registerBlockEntityRenderer(BlockEntityTypes.RAILWAY_SIGN_BOTTOM_2_EVEN, RenderRailwaySignBottom::new);
		RegistryClient.registerBlockEntityRenderer(BlockEntityTypes.RAILWAY_SIGN_BOTTOM_2_ODD, RenderRailwaySignBottom::new);
		RegistryClient.registerBlockEntityRenderer(BlockEntityTypes.RAILWAY_SIGN_BOTTOM_3_EVEN, RenderRailwaySignBottom::new);
		RegistryClient.registerBlockEntityRenderer(BlockEntityTypes.RAILWAY_SIGN_BOTTOM_3_ODD, RenderRailwaySignBottom::new);
		RegistryClient.registerBlockEntityRenderer(BlockEntityTypes.RAILWAY_SIGN_BOTTOM_4_EVEN, RenderRailwaySignBottom::new);
		RegistryClient.registerBlockEntityRenderer(BlockEntityTypes.RAILWAY_SIGN_BOTTOM_4_ODD, RenderRailwaySignBottom::new);
		RegistryClient.registerBlockEntityRenderer(BlockEntityTypes.RAILWAY_SIGN_BOTTOM_5_EVEN, RenderRailwaySignBottom::new);
		RegistryClient.registerBlockEntityRenderer(BlockEntityTypes.RAILWAY_SIGN_BOTTOM_5_ODD, RenderRailwaySignBottom::new);
		RegistryClient.registerBlockEntityRenderer(BlockEntityTypes.RAILWAY_SIGN_BOTTOM_6_EVEN, RenderRailwaySignBottom::new);
		RegistryClient.registerBlockEntityRenderer(BlockEntityTypes.RAILWAY_SIGN_BOTTOM_6_ODD, RenderRailwaySignBottom::new);
		RegistryClient.registerBlockEntityRenderer(BlockEntityTypes.RAILWAY_SIGN_BOTTOM_7_EVEN, RenderRailwaySignBottom::new);
		RegistryClient.registerBlockEntityRenderer(BlockEntityTypes.RAILWAY_SIGN_BOTTOM_7_ODD, RenderRailwaySignBottom::new);
